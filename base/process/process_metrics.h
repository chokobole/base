...
class BASE_EXPORT ProcessMetrics {
 public:
  ProcessMetrics(const ProcessMetrics& other) = delete;
  ProcessMetrics& operator=(const ProcessMetrics& other) = delete;
  ~ProcessMetrics();
  ...
  absl::Duration GetCumulativeCPUUsage();
...
// Exposed for testing.
BASE_EXPORT int ParseProcStatCPU(absl::string_view input);
...
// Exposed for testing.
BASE_EXPORT bool ParseProcMeminfo(absl::string_view input,
...
// returns true on success or false for a parsing error
// Exposed for testing.
BASE_EXPORT bool ParseProcVmstat(absl::string_view input, VmStatInfo* vmstat);
...
BASE_EXPORT bool IsValidDiskName(absl::string_view candidate);
...
BASE_EXPORT absl::Duration GetUserCpuTimeSinceBoot();
...
// Returns true on success or false for a parsing error.
// Exposed for testing.
BASE_EXPORT bool ParseZramMmStat(absl::string_view mm_stat_data,
                                 SwapInfo* swap_info);
...
// Returns true on success or false for a parsing error.
// Exposed for testing.
BASE_EXPORT bool ParseZramStat(absl::string_view stat_data,
                               SwapInfo* swap_info);
