...
class BASE_EXPORT Process {
 public:
  ...
  bool IsRunning() const {
    return !WaitForExitWithTimeout(absl::ZeroDuration(), nullptr);
  }
#endif
  ...
  // is not required.
  bool WaitForExitWithTimeout(absl::Duration timeout, int* exit_code) const;
