...
// thread.
BASE_EXPORT NativeLibrary LoadSystemLibrary(
    absl::string_view name, NativeLibraryLoadError* error = nullptr);
...
BASE_EXPORT NativeLibrary PinSystemLibrary(
    absl::string_view name, NativeLibraryLoadError* error = nullptr);
#endif
...
BASE_EXPORT NativeLibrary LoadNativeLibraryWithOptions(
    const FilePath& library_path, const NativeLibraryOptions& options,
    NativeLibraryLoadError* error);
...
BASE_EXPORT std::string GetNativeLibraryName(absl::string_view name);
