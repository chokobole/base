...
#ifndef BASE_SOCKET_DATAGRAM_CLIENT_SOCKET_H_
#define BASE_SOCKET_DATAGRAM_CLIENT_SOCKET_H_
...
class BASE_EXPORT DatagramClientSocket : public DatagramSocket, public Socket {
 public:
  ...
  // below.
  virtual int WriteAsync(DatagramBuffers buffers,
                         CompletionOnceCallback callback) = 0;

  // |buffer| is copied to an internal |DatagramBuffer|, caller
  // |retains ownership of |buffer|.
  virtual int WriteAsync(const char* buffer, size_t buf_len,
                         CompletionOnceCallback callback) = 0;
...
#endif  // BASE_SOCKET_DATAGRAM_CLIENT_SOCKET_H_
