...
#ifndef BASE_SOCKET_TRANSPORT_CLIENT_SOCKET_H_
#define BASE_SOCKET_TRANSPORT_CLIENT_SOCKET_H_
...
class BASE_EXPORT TransportClientSocket : public StreamSocket {
 public:
  TransportClientSocket();
  TransportClientSocket(const TransportClientSocket& other) = delete;
  TransportClientSocket& operator=(const TransportClientSocket& other) = delete;
  ...
  virtual int Bind(const IPEndPoint& local_addr) = 0;
...
#endif  // BASE_SOCKET_TRANSPORT_CLIENT_SOCKET_H_
